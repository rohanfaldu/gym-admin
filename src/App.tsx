...
import AddGym from './pages/super-admin/AddGym';
...
import AddMember from './pages/gym-admin/AddMember';
import ClassManagement from './pages/gym-admin/ClassManagement';
import AddClass from './pages/gym-admin/AddClass';
import MembershipRequests from './pages/gym-admin/MembershipRequests';
