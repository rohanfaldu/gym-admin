...
const GymAdminLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/gym-admin/dashboard', icon: BarChart3 },
    { name: 'Members', href: '/gym-admin/members', icon: Users },
    { name: 'Classes', href: '/gym-admin/classes', icon: Calendar },
        ...
        <div className="absolute bottom-0 w-full p-4 border-t border-gray-200">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-500">Gym Admin</p>
            </div>
          </div>
          <Button
            variant="ghost"
